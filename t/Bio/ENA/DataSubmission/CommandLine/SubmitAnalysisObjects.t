...
ok($obj->_convert_secondary_project_accession_to_primary_manifest_data,'convert to secondary');
is_deeply($obj->_convert_gffs_to_flatfiles_cmds, 
  ['gff3_to_embl --locus_tag test_genome_1  --output_filename t/data/analysis_submission/test_genome_1.embl "Stap A" "1234" "PRJEB2779" "We assembled some crap! Who cares?" "t/data/analysis_submission/testfile1.gff"',
   'gff3_to_embl --locus_tag test_genome_2  --output_filename t/data/analysis_submission/test_genome_2.embl "Ecoli" "1234" "PRJEB2779" "Assembly of a steaming pile" "t/data/analysis_submission/testfile2.gff"'], 'no commands to convert from gff to embl because its fasta files');
...
ok($obj->_convert_secondary_project_accession_to_primary_manifest_data,'convert to secondary');
is_deeply($obj->_convert_gffs_to_flatfiles_cmds, 
  ['gff3_to_embl --locus_tag test_genome_1 --chromosome_list t/data/analysis_submission/test_genome_1.chromosome_list --output_filename t/data/analysis_submission/test_genome_1.embl "Stap A" "1234" "PRJEB2779" "We assembled some crap! Who cares?" "t/data/analysis_submission/testfile1.gff"',
   'gff3_to_embl --locus_tag test_genome_2 --chromosome_list t/data/analysis_submission/test_genome_2.chromosome_list --output_filename t/data/analysis_submission/test_genome_2.embl "Ecoli" "1234" "PRJEB2779" "Assembly of a steaming pile" "t/data/analysis_submission/testfile2.gff"'], 'no commands to convert from gff to embl because its fasta files');
