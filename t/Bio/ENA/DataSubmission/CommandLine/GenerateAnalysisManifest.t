...
# lane
@exp = ( ['', 'FALSE', '99.37', '', 'SLX', '0', '', '', '', '', 'ERP001039', 'ERS311560', 'ERR363472', 'SC', 'current_date', 'current_date', ''] );
@args = ( '-t', 'lane', '-i', '10665_2#13', '-o', "$tmp/manifest.xls" );
...
# file
@exp = ( 
	['', 'FALSE', '99.37', '', 'SLX', '0', '', '', '', '', 'ERP001039', 'ERS311560', 'ERR363472', 'SC', 'current_date', 'current_date', ''], 
	['', 'FALSE', '86.21', '', 'SLX', '0', '', '', '', '', 'ERP001039', 'ERS311393', 'ERR369155', 'SC', 'current_date', 'current_date', ''],
	['', 'FALSE', '90.22', '', 'SLX', '0', '', '', '', '', 'ERP001039', 'ERS311489', 'ERR369164', 'SC', 'current_date', 'current_date', '']
);
...
# check spreadsheet
@args = ( '-t', 'file', '-i', 't/data/lanes.txt', '-o', "$tmp/manifest.xls", '--pubmed', 'im_a_paper');
$obj = Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifest->new( args => \@args );
ok( $obj->run, 'Manifest generated' );
is_deeply( 
