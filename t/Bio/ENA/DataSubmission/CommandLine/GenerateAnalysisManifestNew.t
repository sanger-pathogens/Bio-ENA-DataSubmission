...
use_ok('Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifestNew');
...
$obj = Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifestNew->new(args => \@args);
...
$obj = Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifestNew->new(args => \@args, _current_date => 'current_date');
