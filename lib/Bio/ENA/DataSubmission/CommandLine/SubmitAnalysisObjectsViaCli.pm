...
has 'config_file' => (is => 'ro', isa => 'Str', required => 0, default => $ENV{'ENA_SUBMISSIONS_CONFIG'});
...
around BUILDARGS => sub {
    ...
    if (exists $args{args}) {
        ...
        my ($spreadsheet, $context, $no_validate, $no_submit, $test, $config_file, $help);
        ...
        if (defined $help || !defined $spreadsheet) {
