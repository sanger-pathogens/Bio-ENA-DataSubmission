package Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifestNew;

# ABSTRACT: module for generation of manifest files for ENA genome update

=head1 NAME

Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifestNew

=head1 SYNOPSIS

	use Bio::ENA::DataSubmission::CommandLine::GenerateAnalysisManifestNew;
