...
sub _manifest_row{
	...
	return [ $sample_acc, $sample_name, $supplier_name, $sample_alias, $taxon_id, $common_name,$common_name, $sample_anonymized_name, $lane_name,'','','','','','1800/2099','','','NA','','NA','','','','','',$sample_name,'','','NA'];
}
